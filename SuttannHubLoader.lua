--[[ 
SuttannHub Loader vStable (Safe FPS Boost + Key System)
Gabungan Intro GUI, Key GUI, dan FPS Boost Aman
--]]
...
-- File simpan key/HWID (hanya di executor tertentu)
local keyFile = "SuttannHubKey.txt"
local HWID = "UNKNOWN_HWID"

pcall(function()
    HWID = (gethwid and gethwid()) or tostring(game:GetService("RbxAnalyticsService"):GetClientId())
end)

-- Ambil daftar key dari Pastebin
local ValidKeyData = ""
pcall(function()
    ValidKeyData = game:HttpGet("https://pastebin.com/raw/c7DnMX7z")
end)
...
wait(4.5)
pcall(function() if Whoosh then Whoosh:Play() end end)
...
-- Jika HWID sudah tersimpan, load script utama
if HasAccess() then
    pcall(function()
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if CheckKey(InputKey) then
        ...
        Notif.TextColor3 = Color3.fromRGB(255,80,80)
        task.wait(1.5)
        pcall(function() LocalPlayer:Kick("Key salah!") end)
    end
end)
